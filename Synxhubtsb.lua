...
local Window = Rayfield:CreateWindow({
   Name = "Synx Hub | The Strongest Battleground (https://discord.gg/ARGCN5qkWC)",
   Icon = 0, -- Icon in Topbar. Can use Lucide Icons (string) or Roblox Image (number). 0 to use no icon (default).
   LoadingTitle = "Synx Hub | https://discord.gg/ARGCN5qkWC",
   LoadingSubtitle = "Powered by Synx TEAM",
